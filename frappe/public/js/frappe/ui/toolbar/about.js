...
frappe.ui.misc.about = function () {
	if (!frappe.ui.misc.about_dialog) {
		var d = new frappe.ui.Dialog({ title: __("Launt Framework") });
		...
		$(d.body).html(
			...
			repl(
				`<div>
					<p>${__("Low Code Framework For Web Application.")}</p>
					<p><i class='fa fa-globe fa-fw'></i>
						${__("Website")}:
						<a href='https://launt.app' target='_blank'>https://launt.app</a></p>
					<p><i class='fa fa-github fa-fw'></i>
						${__("Source")}:
						<a href='https://github.com/launtapp' target='_blank'>https://github.com/launtapp</a></p>
					<hr>
					<h4>${__("Installed Apps")}</h4>
					<div id='about-app-versions'>${__("Loading versions...")}</div>
					</div>`,
